D4-验收 OK D3-数字规范 OK D2-字号表 OK D1-字体表 OK N-sidebar 对齐 OK # 汽车保险网站 设计规范

> 版本：v0.1
> 上游：`visual.md` v0.1（视觉方向）、`prd.md` v0.4（功能与约束）
