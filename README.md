...
- 分区底色节奏：冷白 → 冷灰蓝 → 冷蓝 → **暖米（关于我们）** → 深蓝通栏 → 冷白，浅色档位之间补 1px 发丝线；分区眉标为暖棕 + 前置短横，大标题为主色深蓝
- 「立即投保」深蓝 CTA 通栏 + 末尾「常见问题」栏（复用投保指引的 FAQ）：两者都**不占 Header Tab**，不参与分区滚动导航
...
├── sections/            # 首页分区（Hero、产品、指引、案例、关于 + CTA 通栏、常见问题）
